...
$sqlstring = "select 1 as s,MARKA,
sum(case when [AYRAKAM] = '01' then [Net_Usd_Tutar] else 0 end) 'Ocak',
sum(case when [AYRAKAM] = '02' then [Net_Usd_Tutar] else 0 end) 'Subat',
sum(case when [AYRAKAM] = '03' then [Net_Usd_Tutar] else 0 end) 'Mart',
sum(case when [AYRAKAM] = '04' then [Net_Usd_Tutar] else 0 end) 'Nisan',
sum(case when [AYRAKAM] = '05' then [Net_Usd_Tutar] else 0 end) 'Mayis',
sum(case when [AYRAKAM] = '06' then [Net_Usd_Tutar] else 0 end) 'Haziran',
sum(case when [AYRAKAM] = '07' then [Net_Usd_Tutar] else 0 end) 'Temmuz',
sum(case when [AYRAKAM] = '08' then [Net_Usd_Tutar] else 0 end) 'Agustos',
sum(case when [AYRAKAM] = '09' then [Net_Usd_Tutar] else 0 end) 'Eylul',
sum(case when [AYRAKAM] = '10' then [Net_Usd_Tutar] else 0 end) 'Ekim',
sum(case when [AYRAKAM] = '11' then [Net_Usd_Tutar] else 0 end) 'Kasim',
sum(case when [AYRAKAM] = '12' then [Net_Usd_Tutar] else 0 end) 'Aralik',
sum([Net_Usd_Tutar]) 'TOPLAM'
from ERP_SATIS_ANALIZ_20XX
WHERE Yil='2023'
group by MARKA
ORDER BY TOPLAM desc
