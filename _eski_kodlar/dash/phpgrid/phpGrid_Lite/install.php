			...
			if (substr(trim($line), -1, 1) == ';'){
				...
				if (function_exists("mysqli_connect")){
					...
					if (!mysqli_query($templine)){
						...
						$valid['dbready'] = false;
						$valid['dbready_msg'] .= 'Error performing query \'<strong>' . $templine . '\': ' . mysqli_error() .'</strong>';
						// break;
  ...
  <body>
    ...
    <div class="container" style="padding-top:15px">
      	...
      	<div class="row">
			...
			<h2 class="text-center">Install sample database in your localhost as seen in <a href="https://demo.phpcontrols.com/">Demo Explorer</a></h2>
					...
					<div class="form-group">
						...
						<div class="controls">
							...
							<div class="text-right">
								Having trouble with web install? Try <a href="https://phpgrid.com/documentation/installation/" target="_new" class="btn btn-secondary">Manual Install</a>
							</div>
						</div>
					</div>
