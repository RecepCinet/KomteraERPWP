...
$stmt = $conn->prepare("select _teklif_no,cariKod from aa_erp_kt_fatura_i where [_faturami]='0' AND r_LogoId='$ff'");
$stmt->execute();
...
if ($fatura_tar=="") {
    ...
    $sql="insert into aa_erp_kt_fatura_i (faturaTarihi,irsaliyeTarihi,_faturami,unvan,projeKodu,_teklif_no,cariKod) values ('$baskiTarihi','$baskiTarihi','1','$idler','FATURA','$teklif_no','$ch_kodu')";
}
echo $sql;
