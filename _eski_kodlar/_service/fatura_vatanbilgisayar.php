...
$sqlstring="select magaza from aa_erp_kt_vatan_faturalama group by magaza";
...
-- (select b.CH_UNVANI from aaa_erp_kt_bayiler b where b.CH_KODU='120.03.01.0472') as unvan,
	   ...
	   birim_fiyat,
	   doviz_turu
from aa_erp_kt_vatan_faturalama where magaza='$magaza'
order by id
";
