...
$(function () {
    ...
    var colM = [
        ...
        {title: "Edit", align: "center", editable: false, minWidth: 50, sortable: true,
            render: function (ui) {
        ...
        {title: "Status",editor: {
                    ...
                    getData: function (ui) {
                        ...
                        crules: [{condition: 'range',value: ['In progress','Open']}]
                    }},
        {title: "Type", width: 90, dataIndx: "type",
            editor: {
            ...
            {title: "Priority", width: 85, dataIndx: "priority",
            editor: {
...
//        {title: "CDate", editable: false, minWidth: 80, sortable: true, dataIndx: "cd"},
        ...
        {title: "Modul",editable: false, minWidth: 130, sortable: true, dataIndx: "modul",
            filter: { 
                        crules: [{condition: 'range'}]
                    }
                    },
        {title: "Title",editable: false, width: 230, dataIndx: "title",
            filter: { 
                        crules: [{condition: 'contain'}]
                    }
            },
        {title: "Description",editable: false, width: 410, dataIndx: "description",
            filter: {
                        crules: [{condition: 'contain'}]
                    }
            },
