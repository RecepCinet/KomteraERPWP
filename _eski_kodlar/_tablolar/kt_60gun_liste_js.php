...
function listeden_cikar(t) {
    if (confirm("<?php echo $cryp . " adina log eklenecek? Bu Siparisin listeden cikmasini istiyor musunuz? Bir daha listelenmeyecek!"; ?>")) {
        GonderGelsin(t);
...
$(function () {
    var colM = [
        ...
        {title: "Listeden Cikar", exportRender: false, editable: false, minWidth: 90, sortable: true, dataIndx: "SIPARIS_NO", filter: {
                crules: [{condition: 'contain'}] //,value: ['Açık']
            },
            render: function (ui) {
                return `<a href="#" onclick="listeden_cikar('${ui.rowData.TEKLIF_NO}');">Listeden Çıkar</a>`;
            },
            // postRender: function (ui) {
            //     var grid = this,
            //         $cell = grid.getCell(ui);
        ...
        {title: "Müşteri Adı", editable: false, minWidth: 280, sortable: true, dataIndx: "MUSTERI_ADI",filter: {
                crules: [{condition: 'contain'}]
            }
        },
