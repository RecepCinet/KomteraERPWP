...
<script>
    ...
    $(function () {
        ...
        var colM = [
		    {title: "PB", align: "left", right: false, minWidth: 120, sortable: true, dataIndx: "PARA_BIRIMI", filter: {
			...
			{title: "T Maliyet",exportRender: true,summary: {type: "sum", format: "#.###,00", edit: true},format: "#.###,00", dataType: "float",  align: "right", right: false, minWidth: 120, sortable: true, dataIndx: "TEKLIF_MALIYET", filter: {
                    crules: [{condition: 'contain'}]
                }
            },
			{title: "T Tutar", exportRender: true,summary: {type: "sum", format: "#.###,00", edit: true},format: "#.###,00", dataType: "float",  align: "right", right: false, minWidth: 120, sortable: true, dataIndx: "TEKLIF_TUTAR", filter: {
                    crules: [{condition: 'contain'}]
                }
            },
			{title: "T Kar",exportRender: true,summary: {type: "sum", format: "#.###,00", edit: true},format: "#.###,00", dataType: "float",  align: "right", right: false, minWidth: 120, sortable: true, dataIndx: "KAR", filter: {
                    crules: [{condition: 'contain'}]
                }
            },
