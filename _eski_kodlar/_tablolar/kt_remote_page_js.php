...
//        }
        ...
        var colM = [
            {title: "sku", width: 140, dataIndx: "sku",
                filter: {
                    crules: [{condition: 'begin'}],
                    groupIndx: "SKU"
                }
            },
            {title: "urunAciklama", width: 490, dataIndx: "urunAciklama",
                filter: {
            ...
            {title: "tur", width: 130, dataIndx: "tur",
                render: function (ui) {
            ...
            {title: "cozum", width: 130, dataIndx: "cozum",
                filter: {
                    crules: [{condition: 'range'}]
                }
            },
            {title: "lisansSuresi", align: 'center', width: 90, dataIndx: "lisansSuresi",
                filter: {
                    crules: [{condition: 'contain'}]
                }
            },
            {title: "listeFiyati", align: 'right', width: 80, dataIndx: "listeFiyati"},
            {title: "listeFiyatiUpLift", align: 'right', width: 80, dataIndx: "listeFiyatiUpLift"},
            {title: "paraBirimi", align: 'center', width: 70, dataIndx: "paraBirimi",
                filter: {
                    crules: [{condition: 'contain'}]
                }
            },
