...
$string='select kt_yetki_bayiler from TF_USERS where kullanici=\'' . $cryp . '\'';
//echo $string;
$stmt = $conn2->prepare($string);
$stmt->execute();
$izin = $stmt->fetchAll(PDO::FETCH_ASSOC)[0]['kt_yetki_bayiler'];
...
//        },
        ...
        {title: "CH Ünvanı", editable: false, minWidth: 410, sortable: true, dataIndx: "CH_UNVANI",filter: { 
...
//    },
    ...
    var obj = {
        ...
        sortModel: {
            ...
            toolbar: {
               items: [
                   <?PHP if (YetkiVarmi($izin,'BA-101')=="1") { ?>
                   {
                       type: 'button',
                       label: "Export",
