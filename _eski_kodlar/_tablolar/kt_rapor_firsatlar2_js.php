...
//            },
    ...
    crules: [{condition: 'contain'}]
            ...
            {title: "Siparisler",exportRender: false, style: {'text-color': '#dd0000'}, dataIndx: "Siparisler", align: "left", editable: false, minWidth: 90, sortable: false,
                render: function (ui) {
                    var out = "";
...
//            },
            {title: "Tutar", dataType: "float", render: function (ui) {
                    if (ui.cellData === null) {
            ...
            {title: "Olasılık", minWidth: 210, dataIndx: "OLASILIK",
                render: function (ui) {
			 ...
			 {title: "Olasılık2", minWidth: 210, dataIndx: "OLASILIK",
             
                filter: {
                    crules: [{condition: 'contain'}]
                }
            },
            {title: "Kaybedilme Nedeni", editable: false, minWidth: 160, sortable: true, dataIndx: "KAYBEDILME_NEDENI", filter: {
                    crules: [{condition: 'contain'}]
                }
            },
            {title: "Kaybedilme Nedeni Diğer", editable: false, minWidth: 150, sortable: true, dataIndx: "KAYBEDILME_NEDENI_DIGER", filter: {
                    crules: [{condition: 'contain'}]
                }
...
//                type: 'local',
            ...
            title: 'Fırsatlar: <?PHP echo $_SESSION['user']['kullanici']; ?>',
            resizable: true,
            summaryTitle: "",
            // groupModel: {
            //     on: true,
