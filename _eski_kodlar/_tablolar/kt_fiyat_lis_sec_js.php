    ...
    $(function () {
        var colM = [
            {title: "", style: {'text-color': '#dd0000'}, align: "center", editable: false, minWidth: 40, sortable: false,
                render: function (ui) {
                    return "<a href='#' class='demo_ac' onclick='acac(\"" + ui.rowData.sku + "\",\"" + ui.rowData.wgCategory + "\")'>Ekle</a>";
                }
            },
            ...
            {title: "Stok Durum", width: 80, dataIndx: "STOK_DURUM",
                filter: {
                    crules: [{condition: 'range'}],
                }
            },
            {title: "Stok", width: 80, dataIndx: "STOK_ADET",
                filter: {
                    crules: [{condition: 'range'}],
                }
            },
            {title: "Tür", width: 80, dataIndx: "tur",
                filter: {
                    crules: [{condition: 'range'}],
                }
            },
            {title: "Çözüm", width: 80, dataIndx: "cozum",
                filter: {
                    crules: [{condition: 'range'}]
                }
            },
            {title: "Süre", align: 'center', width: 60, dataIndx: "lisansSuresi",
                filter: {
                    crules: [{condition: 'range'}]
                }
            },
            ...
            {title: "Açıklama", width: 390, dataIndx: "urunAciklama",
                filter: {
                    crules: [{condition: 'contain'}],
        ...
        var obj = {
            ...
            freezeCols: false,
                    rowInit: function (ui) {
            if (ui.rowData.STOK_DURUM == 'STOK VAR') {
                return { 
