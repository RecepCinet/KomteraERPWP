...
$(function () {
    ...
    var colM = [
        ...
        {title: "Firsat NO", exportRender: false, editable: false, minWidth: 90, sortable: true, dataIndx: "FIRSAT_NO", filter: {
                crules: [{condition: 'contain'}] //,value: ['Açık']
            },
            render: function (ui) {
        ...
        {title: "MüşteriTemsilcisi", editable: false, minWidth: 110, sortable: true, dataIndx: "MUSTERI_TEMSILCISI",filter: {
                crules: [{condition: 'contain'}]
            }
        },
        ...
        ,
        {dataType: "date", format: 'dd.mm.yy',title: "YenilemeTarihi", editable: false, minWidth: 80, sortable: true, dataIndx: "YENILEMETARIHI",filter: {
                crules: [{condition: 'contain'}]
            }
        }
        <?PHP
        ...
        ?>
        ,
        {title: "Tarih Düzelt", editable: false, minWidth: 80, sortable: true, dataIndx: "",filter: {
                crules: [{condition: 'contain'}]
            },render: function (ui) {
                var out='';
    ...
    ?>
        ,
        {title: "Alış Fiyatı", editable: false, minWidth: 110, sortable: true, dataIndx: "ALIS_FIYATI",filter: {
                crules: [{condition: 'contain'}]
            }
        }
        ,
        {title: "Satış Fiyatı", editable: false, minWidth: 110, sortable: true, dataIndx: "SATIS_FIYATI",filter: {
                crules: [{condition: 'contain'}]
            }
        }
        ,
        {title: "SKU", editable: false, minWidth: 110, sortable: true, dataIndx: "SKU",filter: {
                crules: [{condition: 'contain'}]
            }
        }
        ,
        {title: "Açıklama", editable: false, minWidth: 110, sortable: true, dataIndx: "ACIKLAMA",filter: {
                crules: [{condition: 'contain'}]
            }
        }
        ,
        ...
        ,
        {title: "Adet", editable: false, minWidth: 110, sortable: true, dataIndx: "ADET",filter: {
                crules: [{condition: 'contain'}]
            }
        }
        ,
        {title: "Müşteri Adı", editable: false, minWidth: 110, sortable: true, dataIndx: "MUSTERI_ADI",filter: {
                crules: [{condition: 'contain'}]
            }
        }
        ,
        {title: "Müşteri Yetkili", editable: false, minWidth: 110, sortable: true, dataIndx: "MUSTERI_YETKILI_ISIM",filter: {
                crules: [{condition: 'contain'}]
            }
        }
        ,
        {title: "Bayi Yetkili", editable: false, minWidth: 110, sortable: true, dataIndx: "BAYI_YETKILI_ISIM",filter: {
                crules: [{condition: 'contain'}]
            }
        },
        {title: "Marka Manager", editable: false, minWidth: 110, sortable: true, dataIndx: "MARKA_MANAGER",filter: {
                crules: [{condition: 'contain'}]
            }
        }
    ];
