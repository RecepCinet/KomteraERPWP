...
<script>
    ...
    $(function () {
        var colM = [
            {title: "AyAdi", align: "left", right: false, minWidth: 120, sortable: true, dataIndx: "AyAdi", filter: {
            ...
            {title: "Birim LFiyat",exportRender: true,format: "#.###,00", dataType: "float",  align: "right", right: false, minWidth: 120, sortable: true, dataIndx: "BLSFIY", filter: {
                    crules: [{condition: 'contain'}]
                }
            },
            ...
            {title: "Tarih", align: "center",exportRender: true, dataType: "date", format: 'dd.mm.yy', hidden: false, editable: false, minWidth: 75, sortable: true, dataIndx: "Tarih", filter: {
                    crules: [{condition: 'range'}]
                }
            },
             {title: "Sipariş No", align: "center",exportRender: true, dataType: "date", format: 'dd.mm.yy', hidden: false, editable: false, minWidth: 80, sortable: true, dataIndx: "Siparis_No", filter: {
                    crules: [{condition: 'range'}]
                }
            },
            ...
            {title: "Musteri", align: "left", right: false, minWidth: 160, sortable: true, dataIndx: "MUSTERI_ADI", filter: {
                    crules: [{condition: 'range'}]
                }
            },
            {title: "Musteri Yetkili", align: "left", right: false, minWidth: 160, sortable: true, dataIndx: "MUSTERI_YETKILI_ISIM", filter: {
                    crules: [{condition: 'contain'}]
                }
            },
