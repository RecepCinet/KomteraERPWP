...
$(function () {
    var colM = [
            ...
            {title: "Fırsat", editable: false, minWidth: 70, sortable: true, dataIndx: "FIRSAT_NO"},
        ...
        render: function (ui) {
            ...
            {title: "FDurum", editable: false, minWidth: 90, sortable: true, dataIndx: "DURUM",
        render: function (ui) {
                    if (ui.cellData === 'Kaybedildi') {
            ...
            {title: "Tarih", format: "dd.mm.yy", editable: false, minWidth: 90, sortable: true, dataIndx: "CD"},
            {title: "Saat", dataType: "date",format: "H:i",editable: false, minWidth: 52, sortable: true, dataIndx: "CT"},
            {title: "Marka", editable: false, minWidth: 110, sortable: true, dataIndx: "MARKA"},
            {title: "Bayi", editable: false, minWidth: 280, sortable: true, dataIndx: "BAYI_ADI"},
            {title: "Müşteri", editable: false, minWidth: 280, sortable: true, dataIndx: "MUSTERI_ADI"},
{title: "Yerinde",align: "center", editable: false, minWidth: 60, sortable: true, dataIndx: "Yerinde"}  ,
{title: "Uzaktan",align: "center", editable: false, minWidth: 60, sortable: true, dataIndx: "Uzaktan"}  ,
{title: "Toplam",align: "center", editable: false, minWidth: 60, sortable: true, dataIndx: "Toplam"}  ,
    ...
    var dataModelSS = {
        ...
        method: "GET",
        recIndx: "id",
        url: "_tablolar/kt_poc.php?dbname=LKS&date1=<?PHP echo $date1; ?>&date2=<?PHP echo $date2; ?>",
