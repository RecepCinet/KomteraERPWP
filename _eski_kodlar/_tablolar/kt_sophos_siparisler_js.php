...
$(function () {
    var colM = [
        {title: "TARIH", editable: false, minWidth: 115, sortable: true, dataIndx: "cd",filter: {
                        crules: [{condition: 'contain'}]
                    }
            },
        {title: "In Out", align: "center", editable: false, minWidth: 60, sortable: true, dataIndx: "in_out",filter: {
                crules: [{condition: 'range'}]
            }
        },
        {title: "Belge No", align: "left", editable: false, minWidth: 120, sortable: true, dataIndx: "belge_no",filter: {
                crules: [{condition: 'contain'}]
            }
        },
        {title: "XML", editable: false, minWidth: 680, sortable: true, dataIndx: "XMLD",filter: {
                crules: [{condition: 'range'}]
            }
        },
        {title: "Cevap", editable: false, minWidth: 120, sortable: true, dataIndx: "cevap",filter: {
                   crules: [{condition: 'contain'}]
               }
           }
