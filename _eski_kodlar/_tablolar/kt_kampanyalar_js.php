...
$(function () {
    ...
    var colM = [
        {title: "Marka", editable: false, minWidth: 100, sortable: true, dataIndx: "id",filter: { 
                        crules: [{condition: 'range'}]
                    }
            },
        {title: "Başlık", align: "left", editable: false, minWidth: 155, sortable: true, dataIndx: "baslik",filter: { 
                        crules: [{condition: 'contain'}]
                    }
            },
        {title: "Kodu", editable: false, minWidth: 120, sortable: true, dataIndx: "kodu",filter: { 
                   crules: [{condition: 'contain'}]
               }
           }
        ,
        {title: "Baslangıç", align: "center", editable: false, minWidth: 90, sortable: true, dataIndx: "tarih_bas"},
        {title: "Bitiş", align: "center", editable: false, minWidth: 90, sortable: true, dataIndx: "tarih_bit",
        filter: {
                        crules: [{condition: 'range'}]
                    },
                     render: function (ui) {
