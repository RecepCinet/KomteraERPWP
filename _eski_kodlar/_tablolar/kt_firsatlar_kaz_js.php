...
//            },
            ...
            {title: "Ka.Teklif",render: function (ui) {
...
//            },
        ...
        var dataModelSS = {
            ...
            method: "GET",
            recIndx: "id",
            url: "_tablolar/kt_firsatlar_kaz.php?dbname=LKS&date1=<?PHP echo $date1; ?>&date2=<?PHP echo $date2; ?>",
...
//                type: 'local',
        ...
        grid = pq.grid("div#grid_firsatlar_kaz", obj);
