...
$dev=0;
if (substr(basename($_SERVER['SCRIPT_NAME']), -8) === '_dev.php') {
    $dev=1;
}
...
$kredi_kontrol=file_get_contents("http://172.16.84.214/_service/rapor_kuru_toplam.php?teklif_no=" . $teklif_no);
if ($kredi_kontrol==1) {
    $ek1=",SIPARIS_DURUM";
    $ek2=",'-1'";
    $ek3=",SIPARIS_DURUM_ALT";
