    ...
    e.render = {
        ...
        onCMInit: function() {
            var t, e, n, r = this,
                ...
                d = i.colModel,
                c = s[a];
            c.titleInFirstCol && d && (n = d.find(function(t) {
                return !t.hidden
            }), c.titleIndx = n.dataIndx = (null == n.dataIndx ? Math.random() : n.dataIndx).toString()), c.checkbox && o && (e = o[c.cbId] || {
                dataIndx: c.cbId
            }, e.cb = {
                check: !0,
                uncheck: !1,
                select: c.select,
                header: c.checkboxHead,
                maxCheck: c.maxCheck
            }, t = l ? o[c.dataIndx] : o[c.titleIndx]), r.colCB = e, r.colUI = t, o && l && r.setCellRender()
        },
        ...
        _summaryT: function(t, e, n, r, i, o, a) {
            for (var l, s, d, c, u, h = this, f = h.childstr, p = h.isGroup, g = o.summaryInTitleRow, v = o.showSummary, m = !o.skipSingleSummary, w = o.titleIndx, x = 0, y = t.length, C = 0, b = {}, I = {}, _ = h.id, q = h.parentId, D = p && a ? o.dataIndx[a.pq_level] : "", R = [], M = n.length, T = pq.aggregate; M > C; C++) u = n[C], b[u] = [];
            for (; y > x; x++) {
        ...
        summaryT: function() {
            for (var t, e, n, r = this, i = r.that, o = i.options, a = o[r.model], l = r.getRoots(), s = [], d = [], c = [], u = [], h = 0, f = i.colModel, p = f.length; p > h; h++) t = f[h], e = t.summary, e && e.type && (c.push(t.dataIndx), u.push(t), d.push(e));
...
function(t) {
    ...
    o._createWidget = function(e, n) {
        return this.origOptions = e, t.Widget.prototype._createWidget.apply(this, arguments)
    }, o._create = function() {
        var e = this,
            n = e.options,
            r = e.element,
        ...
        r.addEventListener("touchstart", function(r) {
            var i = r.target,
                o = r.changedTouches[0],
                a = t.Event("mousedown", o);
            if (a.which = 1, t(i).trigger(a), e) {
                if (i && i == e.target) {
                    var l = e.x - o.pageX,
                        s = e.y - o.pageY,
                        d = Math.sqrt(l * l + s * s);
    ...
    a.setData = function(t) {
        ...
        return M = t.addList = E, T = t.updateList = S, e = M.length, n = k.length, e || T.length || n ? (y && (C.increment(), C.push(t)), o._digestUpdate(T, b, x), n && (o._digestDelete(k, b, x, d, c, h, v, R), D.addRowIndx()), e && (o._digestAdd(M, b, x, d, h, v, R), D.addRowIndx()), o._trigger("change", null, t), !0) : "edit" == q ? null : !1
        ...
        for (var s = 0, d = t.length; d > s; s++) {
            var c = t[s],
                u = c.rowData,
                h = !1,
                f = r.indexOf(u); - 1 == f && (f = i.indexOf(u), f >= 0 && (h = !0)), c.uf = h, c.rowIndx = f
        }
        for (t.sort(function(t, e) {
                return e.rowIndx - t.rowIndx
            }), s = 0; d > s; s++) {
            c = t[s], u = c.rowData, h = c.uf, f = c.rowIndx, n && e["delete"]({
                rowIndx: f,
                rowData: u
            });
            var p = f - l,
        ...
        if (x = "function" == C || "string" == C ? y.callFn(x, w) : x, void 0 === x && "function" == typeof c.geditor && (x = c.geditor.call(y, w)), x !== !1) {
            ...
            S && (w.$editor = M.children(".pq-editor-focus")), D = M.children(".pq-editor-focus");
            var Q = u.filterKeys,
                X = n.getCell(u.indices),
                Y = g.editModel;
            Y && void 0 !== Y.filterKeys && (Q = Y.filterKeys), "textarea" != k && X.empty();
            var Z = {
                $cell: M,
                $editor: D,
                $td: X,
    ...
    n.prototype = {
        ...
        renderCell: function(t) {
            ...
            if (w) {
                ...
                var k, E, S = w[_],
                    S = "string" == typeof S && "html" != y ? pq.escapeHtml(S) : S,
                    P = x.format || (E = w.pq_format) && (E = E[_]),
                    A = P ? this.format(S, P, y) : S;
                if (t.dataIndx = _, t.cellData = S, t.formatVal = A, (c = x.render) && (k = h.callFn(c, t), k && "string" != typeof k && ((e = k.attr) && f.push(I(e)), i = k.prop, (r = k.cls) && m.push(r), n = k.style, k = k.text)), null == k && (c = x._renderG || x._render) && (k = c.call(h, t)), k && "string" != typeof k && ((e = k.attr) && f.push(e), (r = k.cls) && m.push(r), n = k.style, k = k.text), null == k && (k = A || S), g) return [k, n, i, (e || {}).title];
...
function(t) {
    ...
    n.getHeadCell = function(t) {
        ...
        var n = this;
        n.that = e, e.$header.mouse(), e.$header.on({
...
function(t) {
    ...
    r.options = {
        ...
        for (null == e && (e = f > 1); f > h; h++) {
            s = u[h];
            for (d in s) c = s[d], void 0 !== c && (n = !(h > 0), i(c) ? c.byRef ? l[d] = c : (l[d] = l[d] || {}, a(n, l[d], c)) : o(c) ? l[d] = e && n ? c.slice() : c : l[d] = c)
        }
        return l
    ...
    n.prototype = t.extend({
        ...
        _copyArea: function(t, e, n, r, i, o, a, l, s, d, c, u) {
            ...
            for (u && o.push(q.join("	") || " "), g = t; e >= g; g++) {
                ...
                for (q = [], v = n; r >= v; v++) w = i[v], m = w.dataIndx, w.copy !== !1 && (h = M[m], d && (f = C(M, w, I, g, v), f === h && (E.colIndx = v, E.column = w, E.dataIndx = m, f = b(E, c, R)[0], _[v] && /(\r|\n)/.test(f) && (f = this.newLine(f))), q.push(f)), s && void 0 !== h && (T[m] = void 0, k[m] = h));
                s && a.push({
                    rowIndx: g,
                    rowData: M,
                    oldRow: k,
...
function(t) {
    ...
    n.options.trackModel = {
        ...
        onDA: function(t) {
            return function(e, n) {
                "filter" != n.source && (t.udata = [], t.ddata = [],
                    t.adata = [])
            }
        },
...
function(t) {
    ...
    var r = n.cGroup = function(t) {
        ...
        e.model = "groupModel", e.cbId = n.cbId, e.childstr = n.childstr, e.id = n.id, e.parentId = n.parentId, e.isGroup = !0, e.cache = {}, e.prop = "pq_group_prop", e.that = t, Object.defineProperty(n, "nodeClose", {
            get: function() {
                return e.fillState({})
            },
            set: function(t) {
...
function(t) {
    ...
    var n = e.cTree = function(t) {
        var e = this;
        e.model = "treeModel", e.that = t, e.fns = {}, e.init(), e.isTree = !0, e.cache = {}, e.di_prev, e.chkRows = [], Object.defineProperty(t.options.treeModel, "nodeClose", {
            get: function() {
                return e.fillState({})
            },
            set: function(t) {
    ...
    n.prototype = t.extend({}, pq.mixin.ChkGrpTree, pq.mixin.GrpTree, {
        ...
        onChange: function(t, e, n) {
            return function(r, i) {
                var o = i.source || "",
                    a = i.addList.length,
                    l = i.deleteList,
                    s = l.length; - 1 == o.indexOf("checkbox") && ("undo" != o && "redo" != o || !a && !s ? n.summary && n.refreshOnChange && !a && !s ? (t.refreshSummary(!0), e.refresh()) : "addNodes" != o && "deleteNodes" != o || t.refreshViewFull() : t.refreshViewFull(), n.leafIfEmpty && l.forEach(function(e) {
        ...
        onDataReadyAfter: function() {
            var t = this,
                e = t.that,
                n = e.options.treeModel;
            n.summary && t.refreshSummary(), t.showHideRows(), t.isCascade(n) && t.cascadeInit()
        },
        option: function(e, n) {
            var r, i = this,
                o = i.that,
        ...
        _showHideRows: function(t, e, n) {
            for (var r, i, o, a, l, s = this, d = s.id, c = s.nodeClose, u = e || s.getRoots(), h = s.childstr, f = n || !1, p = u.length, g = 0; p > g; g++) o = u[g], o.pq_hidden = f, (l = o[h]) && (c && (r = o[d], i = c[r], null != i && (delete c[r], o.pq_close = i)), a = f || o.pq_close, s._showHideRows(t, l, a))
        },
...
function(t) {
    ...
    n.prototype = {
        ...
        importS: function(t, n, r, i, o) {
            ...
            for (null != o && ($ = o + 1, u = R[o], R = R.slice($), M -= $, M = M > 0 ? M : 0), k = 0, T = R.length; T > k; k++) a = R[k], l = a.indx || k, s = {}, h = s[E] = {}, f = s[S] = {}, p = s[P] = {}, g = s.pq_rowstyle = {}, v = s.pq_rowprop = {}, b.copyStyle(a, v, g), l != k && b.fillRows(I, l, !0), (a.cells || []).forEach(function(t, e) {
...
function(t) {
    ...
    r.prototype = t.extend({
        ...
        getXlsBody: function(n, r, i, o, a, l, s, d, c, u, h) {
            var f, p, g, v, m, w, x, y, C, b, I, _, q, D, R, M, T, k, E, S, P, A, $, H, F, O, V, L, N, j = this,
                B = j.that,
                z = [],
            ...
            for (p = 0; o > p; p++) {
                for (D = i[p], A = D.pq_cellattr, F = D.pq_cellprop || {}, V = D.pq_cellstyle || {}, q = [], R = a ? p + l : p, M = R - l, y = {
                        ...
                        rowData: D,
                        Export: !0
                    }, g = 0; r > g; g++) x = n[g], k = x.style, E = x, T = x.dataIndx, L = V[T], O = F[T], w = D[T], v = w, m = B.getFormula(D, T), f = !1, s.ismergedCell(R, g) && (s.isRootCell(R, g, "o") || (f = !0)), f || m || (y.colIndx = g, y.column = x, y.dataIndx = T, C = j.getRenderVal(y, d, c), v = C[0], b = C[1], _ = C[2], I = C[3]), N = j.getCellFormat(D, T) || x.format, P = {}, "string" == typeof N && (pq.isDateFormat(N) ? (v !== w && t.datepicker.formatDate(N, new Date(w)) === v && (v = w), N = pq.juiToExcel(N)) : (v !== w && pq.formatNumber(w, N) === v && (v = w), N = pq.numToExcel(N)), P.format = N), void 0 !== v && (P.value = v), A && ($ = A[T]) && ((H = $.title) && (P.comment = H), (H = $.style) && j.copyStyle(P, H)), j.copyStyle(P, L, O, k, E), j.copyStyle(P, b, _, k, E), I && (P.comment = I), m && (u && (m = U(m, 0, u)), P.formula = m), pq.isEmpty(P) || (P.dataIndx = T, q.length !== g && (P.indx = g), q.push(P));
                S = {}, q.length && (S.cells = q), D.pq_hidden && (S.hidden = !0), D.pq_htfix && (S.htFix = D.pq_ht), j.copyStyle(S, D.pq_rowstyle, D.pq_rowprop), h && (H = (h.call(B, y) || {}).style, H && j.copyStyle(S, H)), pq.isEmpty(S) || (z.length !== p && (S.indx = p), z.push(S))
            }
            return z
        },
...
function(t) {
    var e = pq.excel = {
        ...
        getBody: function(e, n) {
            var r, i, o, a, l, s, d, c, u, h, f, p, g, v, m, w, x, y, C, b, I = this,
                _ = {},
                q = pq.formulas,
                D = [],
                R = I.comments = {},
        ...
        getStyle: function() {
            var t, e, n, r, i, o, a, l, s, d, c, u, h, f, p, g, v, m, w, x, y = this,
                ...
                T = [],
                k = [],
                E = ['<xf numFmtId="0" applyNumberFormat="1"/>'];
            if (C) {
                delete C.length;
            ...
            if (_) {
                ...
                for (x in _) {
                    ...
                    k.push("<border>"), q.forEach(function(t) {
                        S[t] && (a = S[t].split(" "), k.push("<" + t + ' style="' + ("1px" == a[0] ? "thin" : "double") + '"><color rgb="' + y.getColor(a[2]) + '"/></' + t + ">"))
                    }), k.push("</border>")
                }
                delete y.borders
            }
            if (D) {
                delete D.length;
                for (x in D) a = x.split("_"), l = a[0], s = a[1], d = a[2], c = a[3], u = a[4], h = a[5], f = a[6], p = s ? ' applyFill="1" fillId="' + s + '" ' : "", v = d ? ' applyFont="1" fontId="' + d + '" ' : "", g = l ? ' applyNumberFormat="1" numFmtId="' + l + '"' : "", w = f ? ' applyBorder="1" borderId="' + f + '"' : "", c = c ? ' horizontal="' + c + '" ' : "", u = u ? ' vertical="' + u + '" ' : "", h = h ? ' wrapText="1" ' : "", m = c || u || h ? ' applyAlignment="1"><alignment ' + c + u + h + "/></xf>" : "/>", E.push("<xf " + g + p + v + w + m);
                delete this.styles
            }
            return R = R.join("\n"), E = E.join("\n"), M = M.join("\n"), T = T.join(""), k = k.join("\n"), ['<?xml version="1.0" encoding="UTF-8" standalone="yes"?>', '<styleSheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">', "<numFmts>", R, "</numFmts>", "<fonts>", '<font><sz val="11"/><color theme="1"/><name val="Calibri"/><family val="2"/><scheme val="minor"/></font>', T, "</fonts>", '<fills><fill><patternFill patternType="none"/></fill><fill><patternFill patternType="gray125"/></fill>', M, "</fills>", "<borders><border><left/><right/><top/><bottom/><diagonal/></border>", k, "</borders>", '<cellStyleXfs count="1"><xf numFmtId="0" fontId="0" fillId="0" borderId="0"/>', "</cellStyleXfs>", "<cellXfs>", E, "</cellXfs>", '<cellStyles count="1"><cellStyle name="Normal" xfId="0" builtinId="0"/></cellStyles>', '<dxfs count="0"/><tableStyles count="0" defaultTableStyle="TableStyleMedium9" defaultPivotStyle="PivotStyleLight16"/>', "</styleSheet>"].join("")
        },
        getVml: function() {
            var t, e = [],
                n = this.comments;
