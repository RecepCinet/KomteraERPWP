...
$(function () {
    var colM = [
        ...
        {title: "<?php echo __('bayi','komtera'); ?>", align: "left", editable: false, minWidth: 298, sortable: true, dataIndx: "NAME",filter: {
                        crules: [{condition: 'contain'}]
                    }
            },
        {title: "<?php echo __('edi_no','komtera'); ?>", editable: false, minWidth: 70, sortable: true, dataIndx: "EDI_NO",filter: {
                   crules: [{condition: 'contain'}]
               }
           }
        ,
        ...
        {title: "<?php echo __('seviye','komtera'); ?>", editable: false, minWidth:85, sortable: true, dataIndx: "LEVEL",
        filter: { 
                        crules: [{condition: 'range'}]
                    },
                     render: function (ui) {
...
//        },
        ...
        title: '<?php echo __('logo_edi_cari_eslesme','komtera'); ?>',
        resizable: true,
//        create: function () {
