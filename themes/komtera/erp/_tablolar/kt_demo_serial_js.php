...
$(function () {
    var colM = [
            {title: "<?php echo __('marka','komtera'); ?>", editable: true, minWidth: 150, sortable: true, dataIndx: "MARKA",filter: { 
            ...
            {title: "",style: {'text-color': '#dd0000'}, align: "center", editable: false, minWidth: 95,
                ...
                render: function (ui) {
                    if (ui.rowData.KILIT > 0) {
                        ...
                        return "<a href='#' class='demo_yeni'><?php echo __('demo_olustur','komtera'); ?></a>";
                        <?PHP } ?>
                    }
                },
...
//            },
            ...
            {title: "<?php echo __('seri_no','komtera'); ?>", editable: true, minWidth: 145, sortable: true, dataIndx: "SERIAL_NO",filter: { 
                        crules: [{condition: 'contain'}]
                    }
            },
            {title: "<?php echo __('aciklama','komtera'); ?>", editable: true, minWidth: 420, sortable: true, dataIndx: "ACIKLAMA",filter: { 
                        crules: [{condition: 'contain'}]
                    }
            }
            // ,
    ...
    var obj = {
        ...
        colModel: colM,
        rowInit: function (ui) {
             if (ui.rowData.SATILDI == "<?php echo __('satildi','komtera'); ?>") {
                return { 
        ...
        title: '<?php echo __('logo_demo_stoklari','komtera'); ?>',
        resizable: true,
        rowHt: 23,
//        create: function () {
