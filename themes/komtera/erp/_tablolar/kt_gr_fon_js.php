...
<script>
    ...
    $(function () {
        ...
        var colM = [
            ...
            {title: "<?php echo __('date','komtera'); ?>", sortable: true, minWidth: 80, dataIndx: "Tarih", dataType: "date", format: 'dd.mm.yy'},
...
//            },
            {title: "<?php echo __('cost','komtera'); ?>", exportRender: true,dataType: "float", render: function (ui) {
                    if (ui.cellData === null) {
                        return {style: {"background": "#FF8888"}};
                    }
                },align: "right", format: "#.###,00", editable: false, minWidth: 90, sortable: true, dataIndx: "MALIYET"},
            ...
            {title: "USD_MALIYET",exportRender: true,dataType: "float",render: function (ui) {
                    if (ui.cellData === null) {
                        return {style: {"background": "#FF8888"}};
                    }
                }, summary: {type: "sum", edit: true}, align: "right", format: "#.###,00", editable: false, minWidth: 90, sortable: true, dataIndx: "DLR_MALIYET"},
            ...
            {title: "FON1",exportRender: true,dataType: "float",render: function (ui) {
                }, summary: {type: "sum", edit: true}, align: "right", format: "#.###,00", editable: false, minWidth: 90, sortable: true, dataIndx: "FON1"},
            {title: "FON2",exportRender: true,dataType: "float",render: function (ui) {
                }, summary: {type: "sum", edit: true}, align: "right", format: "#.###,00", editable: false, minWidth: 90, sortable: true, dataIndx: "FON2"},
            {title: "HARCAMA",exportRender: true,dataType: "float",render: function (ui) {
                }, summary: {type: "sum", edit: true}, align: "right", format: "#.###,00", editable: false, minWidth: 90, sortable: true, dataIndx: "HARCAMA"},
        ];
        var dataModelSS = {
            location: "remote",
            dataType: "JSON",
            method: "GET",
            recIndx: "id",
            url: "_tablolar/kt_gr_fon.php?dbname=LKS",
...
//                type: 'local',
        ...
        grid = pq.grid("div#grid_gr_fon", obj);
