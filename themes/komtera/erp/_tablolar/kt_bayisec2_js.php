...
function Sec(ch_kodu) {
    //alert(ch_kodu);
    FileMaker.PerformScript("COMMON_WINDOW", "Bayi_Common_Back" + '\r' + ch_kodu);
}
...
//                }
//            },
        {title: "<?php echo __('ch_title','komtera'); ?>", render: function (ui) {
                        return "<a href='#' onclick=Sec('" + ui.rowData.CH_KODU  + "')>" + ui.rowData.CH_UNVANI + "</a>";                       
                }, editable: false, minWidth: 250, sortable: true, dataIndx: "CH_UNVANI",filter: { 
                        crules: [{condition: 'contain'}]
                    }
            },
        {title: "CH_KODU",align: "center", editable: false, minWidth: 90, sortable: true, dataIndx: "CH_KODU",filter: { 
                        crules: [{condition: 'contain'}]
                    }
            },
        {title: "D", render: function (ui) {
                if (ui.cellData === '1') {
                        return "<a href='#' class='demo_ac'><span class='ui-icon ui-icon-check'></span></a>";                       
                    }
                },
                        align: "center", editable: false, minWidth: 40, sortable: true, dataIndx: "dikkat_listesi"
            },
                {title: "K",render: function (ui) {
                if (ui.cellData === '1') {
                        return "<a href='#' class='demo_ac'><span class='ui-icon ui-icon-check'></span></a>";                       
                    }
                },align: "center",icon: false, editable: false, minWidth: 40, sortable: true, dataIndx: "kara_liste"
            },
        {title: "SOPHOS",align: "center", editable: false, minWidth: 98, sortable: true, dataIndx: "SOPHOS",
     render: function (ui) {
                        return LigGetir(ui.rowData.SOPHOS);                       
                }},
        {title: "WATCHGUARD",align: "center", editable: false, minWidth: 98, sortable: true, dataIndx: "WATCHGUARD",
     render: function (ui) {
    ...
    var dataModelSS = {
        ...
        method: "GET",
        recIndx: "id",
        url: "_tablolar/kt_bayisec2.php?dbname=LKS",
...
//        },
    ...
    grid = pq.grid("div#grid_bayisec2", obj);
    grid.toggle();
