...
<script>
    ...
    var gridPageName = 'kt_rapor_firsatlar_js';
...
//            },
            {title: "<?php echo __('amount','komtera'); ?>", exportRender: true,dataType: "float", render: function (ui) {
                    if (ui.cellData === null) {
            ...
            {title: "USD",dataType: "float",render: function (ui) {
				...
				summary: {type: "sum", edit: true}, align: "right", format: "#.###,00",
        ...
        var dataModelSS = {
            ...
            method: "GET",
            recIndx: "id",
            url: "_tablolar/kt_rapor_firsatlar.php?dbname=LKS&date1=<?PHP echo $date1; ?>&date2=<?PHP echo $date2; ?>",
...
//                type: 'local',
        ...
        grid = pq.grid("div#grid_rapor_firsatlar", obj);
...
//                = grid.getData({ dataIndx: ["ShipCountry", "ShipRegion"] });
            ...
            grid.filter({
                oper: 'add',
                rules: [
                    { dataIndx: 'DURUM', value: ['<?php echo __('open','komtera'); ?>'] }
                ]
            });
