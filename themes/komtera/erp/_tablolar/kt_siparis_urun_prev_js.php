...
<script>
    ...
    $(function () {
        var colM = [
            ...
            {title: "<?php echo __('sku','komtera'); ?>", hidden: false, editable: true, minWidth: 90, sortable: false, dataIndx: "SKU"},
            ...
            {title: "<?php echo __('stok','komtera'); ?>", align: "center", hidden: false, editable: false, minWidth: 55, sortable: false, dataIndx: "STOK"},
            ...
            {title: "<?php echo __('toplam','komtera'); ?>", align: "right", format: "#.###,00", hidden: false, editable: false, minWidth: 80, sortable: false, dataIndx: "TOPLAM"},
            {title: "<?php echo __('lisans','komtera'); ?>", align: "left", format: "#.###,00", hidden: false, editable: false, minWidth: 120, sortable: false, dataIndx: "LISANS"},
            {title: "<?php echo __('ld','komtera'); ?>", align: "center", hidden: false, editable: false, minWidth: 50, sortable: false, dataIndx: "LSONUC"},
            {title: "<?php echo __('logo_mesaj','komtera'); ?>", align: "center", hidden: false, editable: false, minWidth: 280, sortable: false, dataIndx: "LMESAJ"},
        ];
        var dataModelSS = {
            location: "remote",
            dataType: "JSON",
...
//            },
            ...
            title: '<?php echo __('urunler','komtera'); ?>',
            resizable: true,
            //rowHt: 19,
//        create: function () {
