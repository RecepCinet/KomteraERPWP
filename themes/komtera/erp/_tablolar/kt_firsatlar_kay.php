...
f.BAYI_YETKILI_ISIM,
f.MUSTERI_ADI
FROM LKS.dbo." . getTableName('aa_erp_kt_firsatlar') . " f WHERE f.DURUM='-1' AND f.SIL='0' AND CHARINDEX(MARKA, '" . implode(',', get_user_meta(get_current_user_id(), 'my_brands', true) ?: []) . "')>0 and $dates
