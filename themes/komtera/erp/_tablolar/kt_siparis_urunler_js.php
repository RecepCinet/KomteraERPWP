...
//            },
            ...
            {title: "<?php echo __('cihaz_seri_no','komtera'); ?>", align: "left", format: "#.###,00", hidden: false, editable: false, minWidth: 120, sortable: false, dataIndx: "LISANS"},
...
//                }
//            },
            {title: "<?php echo __('sec','komtera'); ?>", style: {"background": "lightgreen"}, align: "center", hidden: true, editable: true, minWidth: 50, sortable: false, dataIndx: "SEC"},
...
if ($parcalama_izni === "1") {
    ?>
            for (let t of colM) {
                if (t.title === "SAd" || t.title === "<?php echo __('sec','komtera'); ?>") {
                    t.hidden = false;
                }
            }
    <?PHP
