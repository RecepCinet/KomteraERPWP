...
<script>
    ...
    $(function () {
        var colM = [
            ...
            {title: "<?php echo __('ch_title','komtera'); ?>", editable: false, minWidth: 480, sortable: false, dataIndx: "CH_UNVANI", filter: {
            ...
            {title: "<?php echo __('dealer_status','komtera'); ?>", editable: false, minWidth: 100, sortable: false, dataIndx: "BAYI"},
