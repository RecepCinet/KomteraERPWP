<script>var grid;
    ...
    $(function () {
        ...
        var colM = [
            ...
            {title: "<?php echo __('rule','komtera'); ?>", align: "left", editable: true, minWidth: 150, sortable: true, dataIndx: "kural",
        cls: 'pq-dropdown pq-side-icon',
                editor: {
                    type: "textbox",
            ...
            {title: "<?php echo __('brand','komtera'); ?>", align: "left", editable: true, minWidth: 120, sortable: true, dataIndx: "marka"},
            {title: "<?php echo __('parameter','komtera'); ?>", align: "left", editable: true, minWidth: 120, sortable: true, dataIndx: "parametre",
                editor: {
                    type: "textbox",
            ...
            {title: "<?php echo __('value','komtera'); ?>", align: "left", editable: true, minWidth: 120, sortable: true, dataIndx: "deger"},
            {title: "<?php echo __('person','komtera'); ?>", align: "left", editable: true, minWidth: 120, sortable: true, dataIndx: "kisi",
                filter: {
                    crules: [{condition: 'range'}]
                }},
            {title: "<?php echo __('action','komtera'); ?>", align: "left", editable: true, minWidth: 120, sortable: true, dataIndx: "islem",
            editor: {
                    type: "textbox",
            ...
            {title: "<?php echo __('email','komtera'); ?>", align: "left", editable: true, minWidth: 120, sortable: true, dataIndx: "eposta",
                filter: {
                    crules: [{condition: 'range'}]
                }}
            ,
            {
                ...
                postRender: function (ui) {
                    ...
                    .bind("click", function () {
                        ...
                        setTimeout(function () {
                            var ans = window.confirm( (rowIndx + 1) + ". <?php echo __('confirm_delete_row','komtera'); ?>");
