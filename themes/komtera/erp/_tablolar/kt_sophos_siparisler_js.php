...
$(function () {
    var colM = [
        {title: "<?php echo __('tarih','komtera'); ?>", editable: false, minWidth: 115, sortable: true, dataIndx: "cd",filter: {
                        crules: [{condition: 'contain'}]
                    }
            },
        {title: "<?php echo __('in_out','komtera'); ?>", align: "center", editable: false, minWidth: 60, sortable: true, dataIndx: "in_out",filter: {
                crules: [{condition: 'range'}]
            }
        },
        {title: "<?php echo __('belge_no','komtera'); ?>", align: "left", editable: false, minWidth: 120, sortable: true, dataIndx: "belge_no",filter: {
                crules: [{condition: 'contain'}]
            }
        },
        {title: "<?php echo __('xml','komtera'); ?>", editable: false, minWidth: 680, sortable: true, dataIndx: "XMLD",filter: {
                crules: [{condition: 'range'}]
            }
        },
        {title: "<?php echo __('cevap','komtera'); ?>", editable: false, minWidth: 120, sortable: true, dataIndx: "cevap",filter: {
                   crules: [{condition: 'contain'}]
               }
           }
    ...
    var dataModelSS = {
        ...
        method: "GET",
        recIndx: "id",
        url: "_tablolar/kt_sophos_siparisler.php?dbname=LKS",
    ...
    var obj = {
       ...
       pageModel: {
        ...
        title: '<?php echo __('logo_edi_cari_eslestirme','komtera'); ?>',
        resizable: true,
//        create: function () {
//                        this.loadState({refresh: false});
//        },
    };
    grid = pq.grid("div#grid_sophos_siparisler", obj);
    grid.toggle();
