...
//            },
            ...
            {title: "Kampanyalar", editable: false, minWidth: 150, sortable: true, dataIndx: "KAMPANYALAR", filter: {
                    crules: [{condition: 'range'}]
                }
        ...
        var dataModelSS = {
            ...
            method: "GET",
            recIndx: "id",
            url: "_tablolar/kt_firsatlar2.php?dbname=LKS&date1=<?PHP echo $date1; ?>&date2=<?PHP echo $date2; ?>",
...
//                type: 'local',
        ...
        grid = pq.grid("div#grid_firsatlar2", obj);
...
//                = grid.getData({ dataIndx: ["ShipCountry", "ShipRegion"] });
            ...
            grid.filter({
                oper: 'add',
                rules: [
                    { dataIndx: 'DURUM', value: ['Açık','Kaybedildi','Kazanıldı'] }
                ]
            });
