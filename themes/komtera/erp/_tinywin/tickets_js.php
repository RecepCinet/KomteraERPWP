    ...
    var colM = [
            ...
            postRender: function (ui) {
                ...
                $cell.find(".edit_btn")
                    ...
                    .bind("click", function (evt) {
                        ...
                        //window.location.replace("fmp://172.16.80.214/Komtera2021?script=Ticket&param=Ac\n" + ui.rowData.id);
                    });
            }
        },
        {title: "Status", editable: true, minWidth: 90, sortable: true, dataIndx: "status",  filter: { 
            ...
            filter: { 
             ...
             editor: {
                    options: ['Komtera', 'Ülke Endüstriyel', 'Ülke Enerji', 'Veri Kurtarma' , 'Lidyum' , 'Utopic Games'],
                    type: function (ui) {
                        //debugger;
                        var options = ui.column.editor.options,
                            str = options.map(function (option) {
        ...
        {title: "Modul", hidden: true, editable: true, minWidth: 90, sortable: true, dataIndx: "modul",filter: { 
                        crules: [{condition: 'range'}]
                    }},          
        {title: "Version", width: 83, dataIndx: "version",
            filter: { 
                        crules: [{condition: 'range'}]
                    }
            },
