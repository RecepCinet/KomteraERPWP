...
//    }
    ...
    $durumm = "98";
    $sqlinsert = "INSERT INTO LKS.dbo.ARYD_FIS_AKTARIM (OZEL_KOD,[SIPARISID],[NO],[CARIKOD],[MALZEMEKOD],[MIKTAR],[FIYAT],[SATIS_TEMSILCISI]
...
$sqlupdate = "update LKS.dbo.ARYD_FIS_AKTARIM set SONUC='0' WHERE SONUC='98'"; //98
try {
