...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $baslik = isset($_POST['baslik']) ? trim($_POST['baslik']) : 'Yeni Kampanya';
    ...
    $tableName = getTableName('aa_erp_kt_kampanyalar');
    ...
    try {
        ...
        echo json_encode(['success' => true, 'message' => 'Yeni kampanya oluşturuldu', 'id' => $newId]);
