...
try {
    ...
    $create_table_sql = "
        IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='aa_erp_kt_teklif_lisans_dosyalar' AND xtype='U')
        CREATE TABLE aa_erp_kt_teklif_lisans_dosyalar (
    ...
    $sql = "SELECT
            ...
            FROM aa_erp_kt_teklif_lisans_dosyalar
