...
try {
    ...
    $create_table_sql = "
        IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='" . getTableName('aa_erp_kt_teklif_lisans_dosyalar') . "' AND xtype='U')
        CREATE TABLE " . getTableName('aa_erp_kt_teklif_lisans_dosyalar') . " (
    ...
    $sql = "SELECT
            ...
            FROM " . getTableName('aa_erp_kt_teklif_lisans_dosyalar') . "
    ...
    error_log('Get Lisans Files Error Details: ' . json_encode($error_details));
    ...
    error_log('Get Lisans Files Fatal Error Details: ' . json_encode($fatal_details));
    ...
    error_log('Get Lisans Files Throwable Error: ' . json_encode($throwable_details));
