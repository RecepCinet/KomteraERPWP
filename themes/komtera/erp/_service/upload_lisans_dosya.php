...
try {
    ...
    $upload_dir = dirname(__DIR__) . '/uploads/lisans_dosyalar/';
    ...
    $filename = $teklif_no . '_lisans_' . time() . '_' . wp_generate_password(8, false) . '.' . $extension;
    ...
    echo json_encode([
        'success' => true,
        'message' => 'Lisans dosyası başarıyla yüklendi',
    ...
    error_log('Lisans Upload Error Details: ' . json_encode($error_details));
    ...
    error_log('Lisans Upload Fatal Error Details: ' . json_encode($fatal_details));
    ...
    error_log('Lisans Upload Throwable Error: ' . json_encode($throwable_details));
